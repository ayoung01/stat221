...
res.sgd = c('sgd', rep.no, run.sgd.2cd(alpha=alpha))
res.asgd = c('asgd', rep.no, run.sgd.2cd(alpha=alpha, asgd=T))
res.implicit = c('implicit', rep.no, run.sgd.2cd(alpha=alpha, implicit=T))
