...
res.sgd = cbind('sgd', rep.no, run.sgd.2cd(alpha=alpha))
res.asgd = cbind('asgd', rep.no, run.sgd.2cd(alpha=alpha, asgd=T))
res.implicit = cbind('implicit', rep.no, run.sgd.2cd(alpha=alpha, implicit=T))
